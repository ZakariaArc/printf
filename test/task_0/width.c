 ...
 * @width: the pointer to a width_t struct containing the width found
 ...
 * @pfn: the pointer to returned func from get_print()
 ...
 * @pfn: the pointer to the function to check
 * @args_copy: the copy of the list of arguments
